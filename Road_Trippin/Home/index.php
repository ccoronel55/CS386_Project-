...
<br>
	  ...
	  <input type="password"  placeholder="Repeat Password" name="password-confirmation" required>
	  </div>
...
<div class="buttons">
		...
		<a href="../pages/Interests.html"><button type="button" id="submitbtn" class="btn btn-info">Sign Up</button></a>
</div>
